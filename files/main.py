...
def updatefont():
    ...
    if newSize < 8 or newSize > 72:
        ...
        return
    ettextinarea.configure(font=("Times New Roman", newSize))
    ettextoutarea.configure(font=("Times New Roman", newSize))
...
ettextinarea = scrolledtext.ScrolledText(textframe, wrap=WORD, width=int(width.get()), height=int(height.get()), font=("Times New Roman", int(fontSize.get())))
ettextinarea.grid(row=1, column=0)
ettextoutarea = scrolledtext.ScrolledText(textframe, wrap=WORD, width=int(width.get()), height=int(height.get()), font=("Times New Roman", int(fontSize.get())))
...
fologarea = scrolledtext.ScrolledText(folderframe, wrap=WORD, width=int(width.get()), height=int(height.get()), font=("Times New Roman", int(fontSize.get())))
